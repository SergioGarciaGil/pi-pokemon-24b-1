...
> Este formulario  está validado con JavaScript y no sólo con validaciones HTML.Por ejemplo: Que el nombre del Pokemon no pueda contener caracteres numéricos, que la altura no pueda ser superior a determinado valor, etc.
